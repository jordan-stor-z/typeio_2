...
- [**Layered**](layered.md) — the project root heads the drawing, with its
  edges to the work derived (`viz:layered`).
- **Rootless** (`viz:rootless`, #215) — the work only, with the project
  root left out entirely. Doc tracked in
  [#226](https://github.com/v12-Industry/typeio_2/issues/226).
