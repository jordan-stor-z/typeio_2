...
- [`architecture/graph-rendering.md`](architecture/graph-rendering.md) — the dependency graph's layout pipeline and rendering: module map, per-phase contracts and invariants, coordinate and edge-direction conventions, the DOM contract, viewport behaviour and the test plan. *Built (#172–#183)*, with one known divergence recorded in it (#198).
