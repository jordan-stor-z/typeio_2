...
- [`solution-proposals/e2e-testing.md`](solution-proposals/e2e-testing.md) — **decided**: browser-driven E2E tooling for the htmx/hyperscript/D3 UI, resolved as Playwright with an on-demand/scheduled CI job (seeded Postgres, running server, headless browser) — implementation not yet ticketed.
