...
- [`solution-proposals/e2e-testing.md`](solution-proposals/e2e-testing.md) — browser-driven E2E tooling for the htmx/hyperscript/D3 UI: Playwright vs. Cypress vs. Puppeteer vs. Selenium/`hspec-webdriver`, and the CI scaffolding (seeded Postgres, running server, headless browser) an E2E job would need.
